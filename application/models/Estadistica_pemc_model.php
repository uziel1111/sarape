...
function get_zonas($sostenimiento, $nivel){
    ...
    function get_porcent_zonas($sostenimiento, $zona, $nivel){
        if ($nivel == 'Todos los niveles') {
            ...
            $where_nivel = " AND e.desc_nivel_educativo = '{$nivel}'";
       ...
       /* $str_query = "SELECT
        ...
        AND e.desc_nivel_educativo not in ('MEDIA SUPERIOR', 'SUPERIOR', 'FORMACION PARA EL TRABAJO', 'OTRO NIVEL EDUCATIVO', 'NO APLICA', 'INICIAL')
