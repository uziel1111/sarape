    ...
    <?php for ($x = 1; $x <= 8; $x++) {
     ...
     <td style="vertical-align: middle;">
      <?php if ($horasRestantesHoy < 0) { ?>        
        <select   onchange="obj_rm_avances_acciones.set_avance('<?=$x?>_<?=$avance['id_cct']?>_<?=$avance['id_tprioritario']?>_<?=$avance['id_accion']?>_<?=$horasRestantes?>_<?=$horasRestantesHoy?>')" id="<?=$x?>_<?=$avance['id_cct']?>_<?=$avance['id_tprioritario']?>_<?=$avance['id_accion']?>_<?=$horasRestantes?>_<?=$horasRestantesHoy?>" title="Acción fuera de tiempo" ><!-- disabled -->
      ...
      <?php }else{ ?>
       <select onchange="obj_rm_avances_acciones.set_avance('<?=$x?>_<?=$avance['id_cct']?>_<?=$avance['id_tprioritario']?>_<?=$avance['id_accion']?>_<?=$horasRestantes?>_<?=$horasRestantesHoy?>')" id="<?=$x?>_<?=$avance['id_cct']?>_<?=$avance['id_tprioritario']?>_<?=$avance['id_accion']?>_<?=$horasRestantes?>_<?=$horasRestantesHoy?>" title="<?=$instruccion?>">
        <option value="0" <?=($avance["cte{$x}"] == '0')? 'selected':'' ?> >0%</option>
        <option value="10" <?=($avance["cte{$x}"] == '10')? 'selected':'' ?> >10%</option>
        <option value="20" <?=($avance["cte{$x}"] == '20')? 'selected':'' ?> >20%</option>
        <option value="30" <?=($avance["cte{$x}"] == '30')? 'selected':'' ?> >30%</option>
