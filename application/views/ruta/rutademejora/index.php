...
<div id="myModal" class="modal fade" role="dialog" aria-labelledby="prioridad_modal" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;" >
	<div class="modal-dialog modal-lg" style="width: 130% !important; margin-left:20% !important;" role="document">
		<div class="modal-content modal-style-1" style="width: 150% !important; align:center !important;">
...
<script type="text/javascript">
	...
	function cteActual() {
		...
		.done(function(data) {
			$('#cteActual').html('Consejo Técnico Escolar Actual: '+ data.cte);
		})
		.fail(function(data) {
		})
		.always(function() {
