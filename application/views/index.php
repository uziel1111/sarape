			...
			<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
				<div class="card main-boxes">
					...
					<div class="card-body">
						<!-- List group -->
						<ul class="list-group">
							<li class="list-group-item"><a class="fw800 fz-16" href="#"><span class="color-1 mr-5"><i class="fas fa-star"></i></span><font SIZE=3> Aprovechamiento <a style="color:grey; padding-left: 10%;" href="#" target="_blank"><b>escolar</b> </font>  <span class="h4 text-white badge badge-secondary bgcolor-1">Proximamente</span></a>
							</li>
