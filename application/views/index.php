				...
				<div class="card main-boxes">
					...
					<div class="card-body">
						...
						<ul class="list-group">
							...
							<li class="list-group-item"><a class="fw800 fz-16" href="<?= base_url('index.php/Rutademejora/index'); ?>" target="_blank"><span class="color-2 mr-5"><i class="fas fa-star"></i></span> <FONT SIZE=3> Programa Escolar de Mejora Continua </font> <span class="h4 text-white badge badge-secondary bgcolor-2">Nuevo</span></a>
							</li>
