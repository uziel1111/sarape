...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-38208772-9"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-38208772-9');
</script>
  <meta charset="utf-8">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-38208772-9"></script>
  <script>  window.dataLayer = window.dataLayer || [];  function gtag(){dataLayer.push(arguments);}  gtag('js', new Date());  gtag('config', 'UA-38208772-9');</script>
...
<script src="<?= base_url('assets/js/sliderengine/amazingslider.js') ?>"></script>
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/sliderengine/amazingslider-1.css') ?>">
<script src="<?= base_url('assets/js/sliderengine/initslider-1.js') ?>"></script>
</head>
<body>
    <div id="top"></div>
    <!-- Start Header Area -->
                        ...
                        <nav class="d-flex align-items-center">
                            <ul class="main-menu">
                              ...
                              <div class="dropdown-menu dropdown-menu-right ddm-color-3" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item hcolor-3" onclick="Index.getAprendeencasa()" href="javascript:void(0)">Aprende en Casa / Programación T.V.</a>
