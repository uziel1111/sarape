...
<input type="hidden" name="t_usuario" id="t_usuario" value="<?=$tipo_usuario?>">
  ...
  <nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      <a class="nav-item nav-link tab-item tab-primary <?=(($tipo_usuario=="escuela")?'three-tab':'tab-graldos')?> active" id="nv_diagnostico<?=$idpemc?><?=$id_turno?>" data-toggle="tab" href="#diagnostico_doc<?=$idpemc?><?=$id_turno?>" role="tab" aria-controls="diagnostico_doc<?=$idpemc?><?=$id_turno?>" aria-selected="true" onclick="Principal_pemc.obtiene_vista_diagnostico('<?=$idpemc?>','<?=$id_turno?>')"><i class="fas fa-file-alt"></i> Diagnóstico</a>
      <a class="nav-item nav-link tab-item tab-secondary <?=(($tipo_usuario=="escuela")?'three-tab':'tab-bigdos')?>" id="nv_objetivos_metas_acciones<?=$idpemc?><?=$id_turno?>" data-toggle="tab" href="#objetivos_metas_acciones_doc<?=$idpemc?><?=$id_turno?>" role="tab" aria-controls="objetivos_metas_acciones_doc<?=$idpemc?><?=$id_turno?>" aria-selected="false" onclick="Principal_pemc.obtiene_vista_obetivos('<?=$idpemc?>','<?=$id_turno?>')"><i class="fas fa-file-invoice"></i> Objetivos, metas y acciones</a>
      <a class="nav-item nav-link tab-item tab-info <?=(($tipo_usuario=="escuela")?'three-tab':'tab-graldos')?>" id="nv_seguimiento<?=$idpemc?><?=$id_turno?>" data-toggle="tab" href="#seguimiento_doc<?=$idpemc?><?=$id_turno?>" role="tab" aria-controls="seguimiento_doc<?=$idpemc?><?=$id_turno?>" aria-selected="false" onclick="Principal_pemc.obtiene_vista_seguimiento('<?=$idpemc?>','<?=$id_turno?>')"><i class="fas fa-archive"></i> Seguimiento</a>
      <a class="nav-item nav-link tab-item tab-primary <?=(($tipo_usuario=="escuela")?'three-tab':'tab-graldos')?>" id="nv_evaluacion<?=$idpemc?><?=$id_turno?>" data-toggle="tab" href="#evaluacion_doc<?=$idpemc?><?=$id_turno?>" role="tab" aria-controls="evaluacion_doc<?=$idpemc?><?=$id_turno?>" aria-selected="true" onclick="Principal_pemc.obtiene_vista_evaluacion('<?=$idpemc?>','<?=$cct?>','<?=$id_turno?>')"><i class="fas fa-file-alt"></i> Evaluación</a>
