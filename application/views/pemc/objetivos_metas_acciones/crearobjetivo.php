<div class="container">
	<form class="form-group" name="form_crear_editar_obj" id="form_crear_editar_obj">
		<div class="form-group">
		    ...
		    <textarea class="form-control" id="text_objetivo_c" rows="3"></textarea>
		 </div>
		 <div class="form-group">
		    <label for="text_meta_c">* Meta</label>
		    <textarea class="form-control" id="text_meta_c" rows="3"></textarea>
		 </div>
		 <div class="form-group">
		    <label for="text_comentariosG_c">Comentarios generales(opcional)</label>
		    <textarea class="form-control" id="text_comentariosG_c" rows="3"></textarea>
		 </div>
		 <div class="row">
