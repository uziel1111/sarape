		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<table class="table table-condensed table-striped">
			  ...
			  <tbody>
			    ...
			    <td><textarea class="form-control" id="txt_accion_<?=$accion['idaccion']?>" rows="3"  maxlength="400"><?=$accion['accion']?></textarea></td>
          ...
          <td colspan="8"><label><b>Línea(s) de Acción Estratégica: </b><span id="inp_laes_<?=$accion['idaccion']?>"></span></label></td>
			    ...
			    <td><textarea class="form-control" id="txt_accion_new" rows="3"   maxlength="400"></textarea></td>
