...
$(".btn-coll_escuela").click(function (e) {
    ...
    $(".icon-escuela_"+cct_escuela).toggleClass('fas fa-chevron-up').toggleClass('fas fa-chevron-down');
    $.ajax({
    	type:"POST",
...
$("#btn-estadisticas").click(function() {
  ...
  .done(function(data) {
     swal.close();
    $('#contenido-estadisticas').html(data.str_view);
...
$('#btn-cerrar_estadisticas').click(function() {
