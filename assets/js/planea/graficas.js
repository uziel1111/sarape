...
function Graficasm(){
  ...
  function showMessage(message){
     ...
     Graficasm.prototype.graficoplanea_ud_secu_lyc19 = function(arr_lyc,id_cct){
        arr_lyc.sort(function (a, b) {
            return (a.porcen_alum_respok - b.porcen_alum_respok)
        });
          Highcharts.theme = {
          ...
          //   );
          // }
      }// graficoplanea_ud_secu_lyc19()

      Graficasm.prototype.graficoplanea_ud_secu_mate19 = function(arr_mate,id_cct){
        arr_mate.sort(function (a, b) {
            return (a.porcen_alum_respok - b.porcen_alum_respok)
        });
          Highcharts.theme = {
